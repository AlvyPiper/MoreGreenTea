...
public:
	...
	virtual void	ChatPrintfW(int iPlayerIndex, int iFilter, const wchar_t *fmt, ...);
...
private:
	CBaseHudChatLine		*FindUnusedChatLine() { return m_ChatLine; }
