...
public:
	...
	IClientUnknown* m_pOuter; // 0x04

	ClientShadowHandle_t m_hShadowHandle; // 0x06
	uint16 m_nRenderFX : 5; // 0x08
	uint16 m_nRenderMode : 4; // 0xA
	uint16 m_bAlphaOverride : 1; // 0xC
	uint8 m_nAlpha; // 0xE
	uint8 m_nReserved2;
	uint16 m_bShadowAlphaOverride : 1; // 0x10
	uint16 m_nDistanceFadeMode : CLIENT_ALPHA_DISTANCE_FADE_MODE_BIT_COUNT; // 0x12
