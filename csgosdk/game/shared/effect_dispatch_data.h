...
public:
	...
	{
		return (IClientRenderable*)entitylist->GetClientEntityFromHandle(m_hEntity);
	}
	C_BaseEntity *GetEntity() const
	{
		return (C_BaseEntity*)entitylist->GetClientEntityFromHandle(m_hEntity);
	}
	int entindex() const
	{
		C_BaseEntity *pEnt = (C_BaseEntity*)entitylist->GetClientEntityFromHandle(m_hEntity);
