...
public:
	...
	// Less func typedef returns true if the first parameter is "less" than the second
	typedef L LessFunc_t;

	// constructor, destructor
	// Left at growSize = 0, the memory will first allocate 1 element and double in size
	// at each increment. LessFunc_t is required, but may be set after the constructor using SetLessFunc() below
