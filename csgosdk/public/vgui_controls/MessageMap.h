...
//  instancing functions
//-----------------------------------------------------------------------------
class CFBuildFactoryHelper
{
public:
	// Static list of helpers
	static CFBuildFactoryHelper *m_sHelpers;

public:
	// Construction
	CFBuildFactoryHelper(char const *className, PANELCREATEFUNC func);

	// Accessors
	CFBuildFactoryHelper *GetNext(void);
