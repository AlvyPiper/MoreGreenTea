...
public:
	...
	// Motion Controller shit
	virtual bool  MotionControllerActive() const = 0;
	virtual int   GetMotionControllerOrientation() const = 0;
	...
	virtual int	  GetMotionControllerDeviceStatusFlags() const = 0;
	virtual void  SetMotionControllerDeviceStatus(int status) = 0;
