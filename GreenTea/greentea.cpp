...
void __fastcall hook::painttraverse(void* thishook, void*, unsigned int vguipanel, bool forcerepaint, bool allowforce) //pass ECX and EDX to the first 2 arguments in the register
{
